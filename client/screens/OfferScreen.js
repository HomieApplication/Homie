...
const OfferScreen = ({ route, navigation }) => {
  ...
  const Mapka = () => {
    if (
      typeof offerData.localization !== "undefined" &&
      ...
      return (
        ...
        >
          <MapView.Marker
            image={mapMarker}
            coordinate={offerData.localization}
          ></MapView.Marker>
        </MapView>
      );
    } else {
  ...
  //w miejscu map tzreba wstawić mape googla z pinezką na lokalizacje danego akademika/mieszkania
    ...
    >
      <View style={styles.card}>
        <View style={styles.contentContainer}>
          <View style={styles.headerContainer}>
            ...
            <View style={styles.headerText}>
              <Text style={styles.textTitle} accessibilityLabel="name">
                {userData.firstName} {userData.lastName}
              </Text>
              <Text style={styles.text} accessibilityLabel="year">
                year of study: {userData.yearOfStudy}
              </Text>
              <Text style={styles.text} accessibilityLabel="description">
          ...
          <View style={styles.descriptionContainer}>
            ...
            <View style={styles.galleryContainer}>
              <View style={styles.galleryImg} accessibilityLabel="gallery">
                <Text>GALERIA</Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.mapContainer}>
          ...
          <View style={styles.mapText} accessibilityLabel="fancy_list">
            <FancyList></FancyList>
          </View>
        </View>
      </View>
