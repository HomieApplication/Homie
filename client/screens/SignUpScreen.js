...
const SignUpScreen = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      {!correctEmail && (
        <Text style={{ color: "red" }} accessibilityLabel="invalid_email">
          Invalid email!
        </Text>
      )}
      <TextInput
      ...
      />
      {!correctPassword && (
        <Text style={{ color: "red" }} accessibilityLabel="password_too_short">
          Password too short!
        </Text>
      )}
      <TextInput
        ...
        accessibilityLabel="confirm_password"
        placeholder="Confirm password"
        secureTextEntry
      />
      {!matchingPasswords && (
        <Text style={{ color: "red" }} accessibilityLabel="different_passwords">
          Different passwords!
        </Text>
      )}
      <TextInput
      ...
      <TextInput
        ...
        value={secondName}
        accessibilityLabel="second_name"
      ...
      <SignInBtn
        ...
        onPress={() => {
          if (!correctEmail || login === "") {
            ...
            displayAlertBox("Failed to register", "Password too short!");
          } else if (!matchingPasswords) {
            displayAlertBox("Failed to register", "Different passwords!");
          } else if (firstName === "") {
            displayAlertBox("Failed to register", "First name is empty!");
          } else if (secondName === "") {
            displayAlertBox("Failed to register", "Second name is empty!");
          } else if (yearOfStudy === "") {
            displayAlertBox("Failed to register", "Year of study is empty!");
          } else {
            try {
