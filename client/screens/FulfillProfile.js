...
const FulfillProfile = ({ navigation }) => {
  ...
  const uploadImage = async (uri) => {
    ...
    const imageRef = ref(
      storage,
      `images/${userId}/${uri.substring(uri.lastIndexOf("/") + 1)}`
    );
          ...
          ListFooterComponent={
            <View style={styles.containerHobby}>
              ...
              <SignInBtn
                ...
                title="Select image"
                accessibilityLabel="select_image_button"
                onPress={() => {
              ...
              <RNMultiSelect
                ...
                accessibilityLabel="hobby_select"
              />

              <SignInBtn
                style={styles.button}
                title="Save Changes"
                accessibilityLabel="save_changes_button"
                onPress={() => {
                  setLoading(true);
